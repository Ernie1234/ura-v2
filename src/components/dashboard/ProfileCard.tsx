...
const ProfileCard = () => {
  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-md">
      <img
        src={
          'https://www.shutterstock.com/image-vector/abstract-orange-background-diagonal-lines-600nw-2490647129.jpg'
        }
        alt="Cover"
      ...
      <div className="mt-4 text-center">
        {isLoading ? (
          <Loader2 size="24px" className="place-self-center self-center animate-spin" />
        ) : (
          <>
        ...
        <Button className="mt-4 bg-orange-500 text-white w-full" asChild>
          <Link to={`/dashboard/profile/${user?._id}`}>My Profile</Link>
        </Button>
      </div>
    </div>
  );
